...
<ul>
  ...
  <li><a href="{{ '/natural-language-processing/' | relative_url }}">Natural Language Processing</a></li>
  <li><a href="{{ '/recommendation-system/' | relative_url }}">Recommendation System</a></li>
</ul>
